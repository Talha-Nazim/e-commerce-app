          ...
          <div>
           ...
           <h2 className="text-base text-gray-400 font-semibold">{product.tagline}</h2>
            ...
            <h3 className="text-xs mt-6 font-semi-bold">SELECT SIZE</h3>
              ...
              {
                sizes.map((item) => {
                 return (<div className="h-6 w-6  rounded-full border hover:shadow-xl mt-2 center">
                 {/* // VARIANTS */}
                  <span className="text-[10px] font-semibold text-center text-gray-500"> {item} </span>
